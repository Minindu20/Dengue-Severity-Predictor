...
def save_results_to_csv(results, filename='predicted_rainfall.dengue_cases_data'):
    """
...
weather_stations = pd.read_csv('../dengue_cases_data/data/stations_RIO.csv')
cities = pd.read_csv('../pre-processing/dengue_cases_data/output/filtered_RJ_cities.csv')
rainfall_data = pd.read_csv(
    '../pre-processing/dengue_cases_data/input/filtered_precipitation_data_2012_2022_by_station.csv')
...
#
# print("Predicted rainfall data has been saved to 'predicted_rainfall.dengue_cases_data'.")
...
file_path = "../krigging/data/sorted_precipitation_data.dengue_cases_data"
